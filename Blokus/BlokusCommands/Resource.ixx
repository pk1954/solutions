...
export inline int const IDD_STOP_TOURNAMENT   { IDM_APPL_CMD + 5 };
export inline int const IDD_NEXT_SHAPE        { IDM_APPL_CMD + 6 };
export inline int const IDM_TOURNAMENT_WINDOW { IDM_APPL_CMD + 7 };
export inline int const IDX_NEXT_AUTO_MOVE    { IDM_APPL_CMD + 8 };
export inline int const IDX_FINISH_MOVE       { IDM_APPL_CMD + 9 };
