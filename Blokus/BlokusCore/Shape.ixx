...
private:
	...
	void colSquare  (DrawContext const&, MicroMeterPnt const, Color const, MicroMeter const) const;
	void shapeSquare(DrawContext const&, CoordPos const&,     Color const, bool const) const;
