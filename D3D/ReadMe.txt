========================================================================
    STATISCHE BIBLIOTHEK: Direct3D-Projektübersicht
========================================================================

Dieses Direct3D-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Direct3D-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Direct3D.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
