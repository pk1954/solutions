...
void HistorySystemImpl::ClearHistory(HistGeneration const genFirst)
{
...
ModelData const * HistorySystemImpl::ApproachHistGen(HistGeneration const genDemanded)
{
...
GenerationCmd HistorySystemImpl::GetGenerationCmd(HistGeneration const gen)
{
...
ModelData const * HistorySystemImpl::GetModelData(HistGeneration const gen)
{
...
HistGeneration HistorySystemImpl::FindGenerationWithProperty
(
