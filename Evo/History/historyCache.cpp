...
HistSlotNr HistoryCache::findSlot4Reuse()
{
    ...
    while (true)
    {
		...
		HistGeneration genJunior       = GetGridGen(slotNrJunior      );
		HistGeneration genSenior       = GetGridGen(slotNrSenior      );
		HistGeneration genSeniorSenior = GetGridGen(slotNrSeniorSenior);

        HistGeneration const thisDiff = genJunior - genSenior;
        HistGeneration const lastDiff = genSenior - genSeniorSenior;
