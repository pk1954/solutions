========================================================================
    KONSOLENANWENDUNG: EvolutionConsole-Projektübersicht
========================================================================

Diese EvolutionConsole-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EvolutionConsole-Anwendung besteht.


EvolutionConsole.vcxproj
...
EvolutionConsole.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EvolutionConsole.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
