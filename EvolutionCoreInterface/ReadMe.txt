========================================================================
    STATISCHE BIBLIOTHEK: EvolutionCoreInterface-Projektübersicht
========================================================================

Dieses EvolutionCoreInterface-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EvolutionCoreInterface-Anwendung besteht.


EvolutionCoreInterface.vcxproj
...
EvolutionCoreInterface.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EvolutionCoreInterface.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
