========================================================================
    STATISCHE BIBLIOTHEK: HistoryInterface-Projektübersicht
========================================================================

Dieses HistoryInterface-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre HistoryInterface-Anwendung besteht.


HistoryInterface.vcxproj
...
HistoryInterface.vcxproj.filters
