...
void GridPointShape::RefreshLayout( )
{
	...
	if ( m_shape.SetShapeRect( PixelPoint( 0_PIXEL, 0_PIXEL ), PixelRectSize( pixFieldSize, pixFieldSize ) ) )
	{
